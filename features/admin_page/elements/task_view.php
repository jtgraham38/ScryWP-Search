...
<div class="scrywp-task-drawer" id="scrywp-task-drawer">
    ...
    <div class="scrywp-task-drawer-header">
        <h2 class="scrywp-task-drawer-title">
            ...
            <?php esc_html_e('Meilisearch Tasks', 'scry-wp'); ?>
        </h2>
        <button type="button" class="scrywp-task-drawer-close" id="scrywp-task-drawer-close" aria-label="<?php esc_attr_e('Close drawer', 'scry-wp'); ?>">
