<dialog id="<?php echo esc_attr($index['index_name']); ?>_settings_dialog" class="scrywp-index-dialog scrywp-index-settings-dialog">
    ...
    <div class="scrywp-index-settings-content">
        ...
        <form class="scrywp-index-settings-form scrywp-index-settings-loaded" data-index-name="<?php echo esc_attr($index['index_name']); ?>" style="display: none;">
            ...
            <div class="scrywp-index-settings-section" data-tab="ranking-rules">
            ...
            <div class="scrywp-index-settings-section" data-tab="searchable-fields">
                <div class="scrywp-index-settings-section-header">
            ...
            <div class="scrywp-index-settings-section scrywp-synonyms-section" data-tab="synonyms" data-index-name="<?php echo esc_attr($index['index_name']); ?>">
                <div class="scrywp-index-settings-section-header">
            ...
            <div class="scrywp-index-settings-section scrywp-stopwords-section" data-tab="stop-words" data-index-name="<?php echo esc_attr($index['index_name']); ?>">
                <div class="scrywp-index-settings-section-header">
